...
def parse_args():
    ...
    parser.add_argument("--classifier-learning-rate", type=float, default=0.001, required=False,
                        help="Learning rate for Adam optimizer. (Classfier)",
...
if __name__ == '__main__':
    ...
    hof, _ = ga.run(x=train_x,
                    ...
                    classifer_learning_rate=CLASSIFIER_LEARNING_RATE,
                    classifer_beta_1=CLASSIFIER_BETA_1,
                    classifer_beta_2=CLASSIFIER_BETA_2,
                    classifer_batch_size=CLASSIFIER_BATCH_SIZE,
                    classifer_num_epochs=CLASSIFIER_BATCH_SIZE,
                    classifer_run_device=CLASSIFIER_RUN_DEVICE)
